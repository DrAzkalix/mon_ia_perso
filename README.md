...
1. 🏗️ **Infrastructure de production** — Agents IA communicants via le protocole MCP
2. 📓 **Journal de formation** — Documentation détaillée de chaque session d'apprentissage
3. 🎓 **Base pour un SaaS** — Fondations pour une future plateforme de formation IA

### Stack technique

| Composant | Rôle | Technologie |
|-----------|------|-------------|
| **Hermes Agent** | Agent principal | ChatGPT Codex |
| **OpenClaw (Alex)** | Sous-agent spécialisé marketing | Claude Sonnet 4.6 |
| **MCP** | Protocole inter-agents | Model Context Protocol |
| **Docker** | Conteneurisation | Docker + Docker Compose |
| **systemd** | Persistance et supervision | systemd services |
| **Bridge Python** | Traducteur MCP ↔ HTTP | Python 3.11 + mcp SDK |
...
|-----------|------|-------------|
| **Hermes** | Reçoit les demandes utilisateur, utilise MCP | Container `hermes-agent-XXXX` |
| **Bridge Python** | Traduit MCP (stdio) ↔ HTTP OpenAI-compatible | `/opt/data/openclaw_bridge.py` |
| **Wrapper Shell** | Injecte les variables d'environnement | `/opt/data/openclaw_bridge.sh` |
| **socat** | Relais TCP (18790 public → 18789 loopback) | Installé via brew dans OpenClaw |
| **OpenClaw (Alex)** | Sous-agent spécialisé | Container `openclaw-XXXX` |
| **systemd** | Gardien qui relance socat en cas de crash | `/etc/systemd/system/` |
...
Consulte le [**Guide d'installation complet**](documents/guide-installation-hermes-openclaw.md) pour une procédure pas à pas détaillée (**6 étapes, ~2h30**).

Un [**PDF de formation**](documents/hermes-openclaw-guide-complet.pdf) (27 pages, technique + pédagogique) est également disponible.
...
Voir le [guide complet](documents/guide-installation-hermes-openclaw.md) pour les scripts détaillés.
...
|---------|--------|--------|-------------|
| [Guide complet](documents/guide-installation-hermes-openclaw.md) | Markdown | ~17 KB | Guide technique pour GitHub |
| [PDF de formation](documents/hermes-openclaw-guide-complet.pdf) | PDF | 27 pages | Support de formation complet |
...
Le dossier [`journal/`](journal/) contient les sessions d'apprentissage chronologiques.

| Date | Sujet | Durée | Statut |
|------|-------|-------|--------|
| **2026-04-22** | Installation complète Hermes ↔ OpenClaw via MCP | 3h30 | ✅ Complété |
...
Ouvre une [issue](https://github.com/DrAzkalix/mon_ia_perso/issues) avec :
...
1. Crée un fichier `journal/YYYY-MM-DD-titre-session.md`
2. Suis le format du journal existant
...
- 🔗 **Documentation socat :** [dest-unreach.org/socat](http://www.dest-unreach.org/socat/)
- 🔗 **Anthropic Claude :** [docs.anthropic.com](https://docs.anthropic.com)

### Projets liés

- 🔗 **hermes-skills-autopilot :** [github.com/DrFIRASS/hermes-skills-autopilot](https://github.com/DrFIRASS/hermes-skills-autopilot)
...
- 🔗 GitHub : [@DrAzkalix](https://github.com/DrAzkalix)
...
**Dernière mise à jour :** Avril 2026 · **Version :** 1.0.0 · **Statut :** ✅ Opérationnel

⭐ **Si ce projet te plaît, n'hésite pas à lui mettre une étoile !** ⭐
